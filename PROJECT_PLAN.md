...
P2、P3、P4、P5 与 P6 已完成验收，P6 已通过 `7de8d07` 本地 no-ff 合并。P7 已建立 `make test/check/test-host/loc/demo-persistence`、固定容器 Linux CI 工作流与 release checklist；正式 WSL 聚合入口完成环境验证、完整构建/fsck 和全量宿主/QEMU 243/243 PASS，双启动持久化演示 PASS。下一步完成原生 Linux CI 首次运行、最终文档与阶段报告后进行交付审计。
