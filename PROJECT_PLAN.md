...
P2、P3 与 P4 已完成验收。P4 的 Ring 3/TSS、三线程抢占调度、用户地址空间、故障隔离、sleep/waitpid、PID 复用、可抢占安全 Heap 及 `int 0x80` 最小调用均通过环境验证、干净构建、真实 QEMU 与全量宿主回归。下一步进入 P5 ELF 用户态与 Shell。
