...
P2、P3、P4、P5 与 P6 已完成验收，P6 已通过 `7de8d07` 本地 no-ff 合并。P7 已建立并验收 `make test/check/test-host/loc/demo-persistence`、固定容器 Linux CI、失败证据上传与 release checklist；正式 WSL 聚合入口完成环境验证、完整构建/fsck 和全量宿主/QEMU 243/243 PASS，双启动持久化演示 PASS；原生 Ubuntu 24.04 CI 对 `69be0c2` 完成环境验证及 246/246 PASS。P7 分支验收完成，下一步执行本地 no-ff 合并与最终工作树审计。
