...
| P4 进程与系统调用 | 收口中 | Ring 3/TSS、PCB/内核栈、PIT 抢占、用户页目录、用户 #PF 隔离、sleep/waitpid、PID 复用、IRQ-safe Heap 及 7 个最小 `int 0x80` 调用已实现；启动专项 28/28、上一稳定点全量宿主 222/222；最终干净构建/全量回归和阶段合并待完成 |
