...
| P6 磁盘与 MiniFS | 进行中 | 已完成 ATA PIO、4 KiB block、固定磁盘 ABI、确定性 mkfs、整盘装配与只读 fsck；真实 QEMU 块自检 PASS，MiniFS 工具 6/6、构建契约 9/9、运行时构建回归 21/21；内核 MiniFS、VFS、fd、文件命令与持久化待完成 |
