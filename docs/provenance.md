...
| Stage 2 Loader | 从零实现 16 位入口、串口诊断、BIOS 接口、A20/E820 与临时 GDT/保护模式切换；后续能力并入 P1 启动链完成 | BIOS 中断接口、x86 实模式/保护模式与 ELF32 链接规则 | 否 | T11 已验收；P1 的 A20/E820/保护模式增量已通过真实 QEMU，ATA/ELF/Boot Info 待实现 |
