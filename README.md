...
P0 工程基础、P1 启动链、P2 内核基础/中断与 P3 内存管理已完成，P4 进程与系统调用正在实施。当前已安装 Ring 3 code/data 描述符、32 位 TSS，并完成静态 PCB、独立内核栈与协作式 round-robin 内核线程切换；PIT 抢占、Ring 3 进入和 `int 0x80` 仍待完成。真实状态以 `docs/progress.md` 和阶段报告为准。
